...
roomsRouter.get("/rooms/:id", async (request, response) => {
  try {
...
roomsRouter.post("/rooms", async (request, response) => {
  try {
...
roomsRouter.put("/rooms/:id", async (request, response) => {
  try {
    const { id } = request.params;
...
roomsRouter.delete("/rooms/:id", async (request, response) => {
  try {
    const { id } = request.params;
