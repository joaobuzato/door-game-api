...
actionsRouter.get("/actions", async (request, response) => {
  try {
...
actionsRouter.get("/actions/:id", async (request, response) => {
  try {
...
actionsRouter.post("/actions", async (request, response) => {
  try {
...
actionsRouter.put("/actions/:id", async (request, response) => {
  try {
    const { id } = request.params;
...
actionsRouter.delete("/actions/:id", async (request, response) => {
  try {
    const { id } = request.params;
